...
class Piattino : Entity, HasPhysics, HasCollision, HasAnchoring, HasModel, IsMovable, IsRestricted, HasAudio, HasNetwork, HasHitSound, HasNickname
{
    required init(modelComponent : ModelComponent,movableComponent : MovableComponent,tranform : Transform,restrictionComponent : RestrictionComponent,audioComponent : AudioComponent,network:NetworkComponent,hitSound:HitSoundComponent, nickname : NickComponent) {
        super.init()
        self.model = nil
